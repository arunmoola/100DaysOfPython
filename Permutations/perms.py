...
def count_achievable_scores(ring_scores, num_arrows, min_score, max_score):
    ...
    for combination in combinations_with_replacement(ring_scores, num_arrows):
        ...
        if min_score <= total_score <= max_score:
            achievable_scores.add(total_score)
    ...
    return count, sorted(achievable_scores)
...
print(f"Achievable scores: {achievable}")
...
print(f"Achievable scores: {custom_achievable}")